...
If HeyClawy has issues, `esphome-fallback.yaml` contains the working ESPHome/Home Assistant
config that was previously running on this device. Flash via ESPHome dashboard.

## Files

- `PLAN.md` — Original implementation plan
- `esphome-fallback.yaml` — ESPHome config (HA voice pipeline, known working)
- `../../build_box3.sh` — Build script
- `../../components/board/include/board_esp32s3box3.h` — Pin definitions
